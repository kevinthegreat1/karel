			...
			if (saver == null) {
				try {
					...
					if (suffix.equals("BMP")) {
						imageSaverClass = BMPImageSaver.class;
					} else if (suffix.equals("EPS")) {
						imageSaverClass = EPSImageSaver.class;
					} else if (suffix.equals("GIF")) {
						imageSaverClass = GIFImageSaver.class;
					} else if (suffix.equals("GIF89")) {
						imageSaverClass = GIF89ImageSaver.class;
					} else if (suffix.equals("JPEG")) {
						imageSaverClass = JPEGImageSaver.class;
					} else if (suffix.equals("JPG")) {
						imageSaverClass = JPGImageSaver.class;
					} else if (suffix.equals("PICT")) {
						imageSaverClass = PICTImageSaver.class;
					} else if (suffix.equals("PNG")) {
						imageSaverClass = PNGImageSaver.class;
					} else if (suffix.equals("RTF")) {
						imageSaverClass = RTFImageSaver.class;
					} else if (suffix.equals("TIFF")) {
						imageSaverClass = TIFFImageSaver.class;
					} else {
