...
import acm.util.PatchingClassLoader;
import stanford.karel.HeadlessSuperKarel;
import stanford.karel.KarelInterface;
...
public class CommandLineProgram
	...
	public static boolean isHeadless() {
		...
		try {
			Class<?> gEnvClass = GraphicsEnvironment.class;
		...
		try {
			...
			if (isConsole) {
				loader = new PatchingClassLoader(className,
						/* new superclass */ CommandLineProgram.class);
			} else if (isKarel) {
				loader = new PatchingClassLoader(className,
						/* new superclass */ HeadlessSuperKarel.class);
			} else if (isGraphics) {
				loader = new PatchingClassLoader(className,
						/* new superclass */ HeadlessGraphicsProgram.class);
			}
