...
class SwingDialogModel implements DialogModel {
   ...
   public void popupMessage(String var1) {
      JOptionPane.showMessageDialog(this.myComponent, var1);
   }

   public void popupErrorMessage(String var1) {
      JOptionPane.showMessageDialog(this.myComponent, var1, "Error", 0);
   }

   public String popupLineInputDialog(String var1, boolean var2) {
      JOptionPane var3;
      if (var2) {
         var3 = new JOptionPane(var1, 3, 2, inputIcon);
         var3.setWantsInput(true);
      } else {
         Object[] var4 = new Object[]{"OK"};
         var3 = new JOptionPane(var1, 3, 2, inputIcon, var4, var4[0]);
         var3.setWantsInput(true);
         var3.setInputValue("");
      }

      JDialog var6 = var3.createDialog(this.myComponent, "Input");
      var6.setVisible(true);
      Object var5 = var3.getInputValue();
      return var5 == JOptionPane.UNINITIALIZED_VALUE ? null : (String)var5;
   }

   public Boolean popupBooleanInputDialog(String var1, String var2, String var3, boolean var4) {
      Object[] var5;
      if (var4) {
         var5 = new Object[]{null, null, "Cancel"};
      } else {
         var5 = new Object[2];
      }
      ...
      var5[0] = var2;
      var5[1] = var3;
      String var6 = var2 + "/" + var3 + " question";
      int var7 = JOptionPane.showOptionDialog(this.myComponent, var1, var6, -1, 3, inputIcon, var5, var5[0]);
      switch (var7) {
         case 0:
            return Boolean.TRUE;
         case 1:
